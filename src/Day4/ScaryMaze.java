...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	BufferedImage maze;
	final int frameWidth = 696;
	final int frameHeight = 507;
...
addMouseMotionListener(this);
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Scream And Die Fx-SoundBible.com-299479967.wav"));
		sound.play();
